...
public abstract class AbstractDialogRequirement {
    ...
    public abstract boolean handler(Player player, Conversation dialog, int option_id, Entity entity) throws IOException;

    public abstract boolean handler(Player player, Conversation dialog, int option_id, String resourceLocation) throws IOException;

    public abstract boolean handler(Player player, Conversation dialog, int option_id, Item item) throws IOException;
}
