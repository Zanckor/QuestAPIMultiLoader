package net.zanckor.questapi.api.filemanager.npc.entity_type_tag.codec;

import net.zanckor.questapi.api.filemanager.FileAbstract;
import net.zanckor.questapi.api.filemanager.npc.entity_type_tag.gateenum.LogicGate;
