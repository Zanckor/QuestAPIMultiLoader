package net.zanckor.questapi.api.filemanager;
...
//TODO: Esta clase deberia estar en FORGE-FABRIC


//@EventBusSubscriber(modid = QuestApiMain.MOD_ID, bus = EventBusSubscriber.Bus.FORGE)
