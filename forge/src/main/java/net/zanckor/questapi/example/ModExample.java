...
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.LoadDialog;
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.LoadDialogList;
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.LoadQuest;
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.LoadTagDialogList;
...
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.enumquest.EnumGoalType;
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.enumquest.EnumQuestRequirement;
import net.zanckor.questapi.mod.filemanager.dialogquestregistry.enumquest.EnumQuestReward;
import net.zanckor.questapi.example.screen.dialog.DialogScreen;
import net.zanckor.questapi.example.screen.dialog.MinimalistDialogScreen;
import net.zanckor.questapi.example.screen.hud.RenderQuestTracker;
import net.zanckor.questapi.example.screen.questlog.QuestLog;
