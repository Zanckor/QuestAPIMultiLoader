...
import net.zanckor.questapi.common.network.message.dialogoption.AddQuest;
import net.zanckor.questapi.common.network.message.dialogoption.CloseDialog;
import net.zanckor.questapi.common.network.message.dialogoption.DialogRequestPacket;
import net.zanckor.questapi.common.network.message.dialogoption.DisplayDialog;
import net.zanckor.questapi.common.network.message.npcmarker.ValidNPCMarker;
import net.zanckor.questapi.common.network.message.quest.*;
import net.zanckor.questapi.common.network.message.screen.*;
import net.minecraft.resources.ResourceLocation;
import net.minecraftforge.network.NetworkDirection;
import net.minecraftforge.network.NetworkRegistry;
import net.minecraftforge.network.simple.SimpleChannel;
import net.zanckor.questapi.common.network.message.quest.QuestDataPacket;
